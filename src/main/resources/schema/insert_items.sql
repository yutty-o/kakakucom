...
INSERT INTO `kakakucom`.`stores` (`name`, `url`, `address`, `tel`, `bank_pay`, `credit_pay`, `convenience_pay`) VALUES ('レノボ・ショッピング', 'http://www3.lenovo.com/jp/ja/kakaku/deals/kakakumb/c/kakakumb', '東京都千代田区外神田4-14-1 秋葉原UDX', '0120-80-4545', TRUE, TRUE, TRUE);
...
INSERT INTO `kakakucom`.`store_item` (`store_id`, `item_id`, `price`, `stock`, `shipping_period`, `area`, `comment`, `color`, `url`, `is_deleted`) VALUES ('1', '2', '78900', '3', '2営業日', '大阪', '■延長保証制度あり', '00ff00', 'http://jp.ext.hp.com/notebooks/personal/hp_15_ba000/kakaku.html', 0);
